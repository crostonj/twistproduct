...
/**
 * DTO for API responses with complete product information
 */
public class ProductResponseDTO {
    ...
    public String getProductAreaName() { return productAreaName; }
    public void setProductAreaName(String productAreaName) { this.productAreaName = productAreaName; }
